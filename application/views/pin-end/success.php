    ...
    <div class="container mt-5">
        <div class="card p-4" style="margin-top: 200px; background-color:mediumseagreen; border-color:green">
            ...
            <div class="row container mt-5">
                ...
                <a href="<?php echo prefix_url;?>app/form" class="btn btn-secondary mr-3"> Back to History</a>
                <a class="btn btn-danger" target="blank" href=" <?php echo base_url('app/pin_end/print/' . get_cookie('eval')) ?>"> <i class="fa fa-print"></i> Print</a> &nbsp;
