...
<body>
    ...
    <div class="container mt-5">
        <div class="card p-4">
            ...
            <?php echo form_open('app/pin_end/page8'); ?>
            ...
            <a class="btn btn-default" href="<?php echo prefix_url;?>app/pin_end/page7" role="button">Previous</a> &nbsp;
            <button class="btn btn-primary" href="<?php echo prefix_url;?>app/pin_end/page9"> Next</button> &nbsp;
