...
<body>
  ...
  <div class="container mt-5">
    <div class="card p-4">
      ...
      <?php echo form_open('app/form/page4'); ?>


      <nav class="navbar navbar-light bg-info ">
        <h4 class="navbar mb-0 h5 text-white py-1">BEARING FACE (B)</h4>
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          <label class="radio-inline">
            <input type="radio" name="face_b" value="inch" <?= (get_cookie('face_b') == 'inch') ? "checked" : null  ?> > &nbsp; &nbsp; inch</label> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
          <label class="mt-2 mb-1" class="radio-inline">
            <input type="radio" name="face_b" value="mm" <?= (get_cookie('face_b') == 'mm') ? "checked" : null  ?> > &nbsp; &nbsp; mm</label>
        </div>
      </div>
      <?php echo form_error('face_b'); ?>
      ...
      <nav class="navbar navbar-light bg-info ">
        <h4 class="navbar mb-0 h5 text-white py-1">OUTSIDE DIAMETER (W)</h4>
      </nav>
      <br>
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          <label class="radio-inline">
            <input type="radio" name="diameter_w" value="inch" <?= (get_cookie('diameter_w') == 'inch') ? "checked" : null  ?> > &nbsp; &nbsp; inch</label> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
          <label class="mt-2 mb-1" class="radio-inline">
            <input type="radio" name="diameter_w" value="mm" <?= (get_cookie('diameter_w') == 'mm') ? "checked" : null  ?> > &nbsp; &nbsp; mm</label>
        </div>
      </div>
      <?php echo form_error('diameter_w'); ?>
      ...
      <a class="btn btn-default" href="<?php echo prefix_url;?>app/form/page3" role="button">Previous</a> &nbsp;
      <button class="btn btn-primary" href="<?php echo prefix_url;?>app/form/page5"> Next</button> &nbsp;
