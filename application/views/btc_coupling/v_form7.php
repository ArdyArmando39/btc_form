...
<body>
    ...
    <div class="container mt-5">
        <div class="card p-4">
            ...
            <?php echo form_open('app/form/page7'); ?>
            ...
            <a class="btn btn-default" href="<?php echo prefix_url;?>app/form/page6" role="button">Previous</a> &nbsp;
            <button class="btn btn-primary" href="<?php echo prefix_url;?>app/form/page8"> Next</button> &nbsp;
